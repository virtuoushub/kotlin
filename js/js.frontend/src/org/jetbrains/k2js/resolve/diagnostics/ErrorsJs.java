...
public interface ErrorsJs {
    ...
    DiagnosticFactory1<JetElement, JetType> NATIVE_X_ALLOWED_ONLY_ON_MEMBER_OR_EXTENSION_FUN = DiagnosticFactory1.create(ERROR, DECLARATION_SIGNATURE_OR_DEFAULT);
