...
public class TypeApproximationTestGenerated extends AbstractTypeApproximationTest {
    ...
    public void testContravariant() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("compiler/testData/typeApproximation/contravariant.kt");
        doTest(fileName);
    }

    @TestMetadata("covariant.kt")
    public void testCovariant() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("compiler/testData/typeApproximation/covariant.kt");
        doTest(fileName);
    }

    @TestMetadata("invariant.kt")
    public void testInvariant() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("compiler/testData/typeApproximation/invariant.kt");
        doTest(fileName);
    }

    @TestMetadata("nestedCov.kt")
    public void testNestedCov() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("compiler/testData/typeApproximation/nestedCov.kt");
        doTest(fileName);
    }

    @TestMetadata("nestedInv.kt")
    public void testNestedInv() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("compiler/testData/typeApproximation/nestedInv.kt");
        doTest(fileName);
    }

    @TestMetadata("nestedInvLevel2.kt")
    public void testNestedInvLevel2() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("compiler/testData/typeApproximation/nestedInvLevel2.kt");
        doTest(fileName);
    }

    @TestMetadata("useSiteVarianceIn.kt")
    public void testUseSiteVarianceIn() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("compiler/testData/typeApproximation/useSiteVarianceIn.kt");
        doTest(fileName);
    }

    @TestMetadata("useSiteVarianceOut.kt")
    public void testUseSiteVarianceOut() throws Exception {
        String fileName = JetTestUtils.navigationMetadata("compiler/testData/typeApproximation/useSiteVarianceOut.kt");
        doTest(fileName);
    }
}
