...
object NamedParametersCompletion {
    ...
    public fun isOnlyNamedParameterExpected(position: PsiElement): Boolean {
        ...
        val thisArgument = position.getParentByType<JetValueArgument>()!!

        val callElement = thisArgument.getParentByType<JetCallElement>() ?: return false
    ...
    public fun complete(position: PsiElement, collector: LookupElementsCollector) {
        ...
        val valueArgument = position.getParentByType<JetValueArgument>()!!

        val callElement = valueArgument.getParentByType<JetCallElement>() ?: return
